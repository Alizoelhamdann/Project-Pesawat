...
<body>
    ...
    <div id="carouselBackground" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-indicators">
            ...
            <button type="button" data-bs-target="#carouselBackground" data-bs-slide-to="1"
                aria-label="Slide 2"></button>
            <button type="button" data-bs-target="#carouselBackground" data-bs-slide-to="2"
                        ...
                        <div class="row no-gutters slider-text align-items-center justify-content-center">
                            <div class="col-md-12 ftco-animate text-center">
                                <div class="text mb-5 pb-3 animated-text">
                                    <h1 class="mb-3">Selamat Datang di <span style="color : red;">SIGMA</span> FLIGHTS!
                                    </h1>
                                    <p>Kami bangga melayani Anda dengan penerbangan terbaik dan kenyamanan terunggul.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <img src="../public/img/logo.png" alt="Logo Sigma Flights" width="100" height="60"
                            class="d-inline-block align-top" style="position: absolute; top: 10px; right: 1100px;">
                    </div>
                </div>
            </div>
            <div class="carousel-item">
                <div class="slider-item" style="background-image:url('../public/img/slide2.jpeg');">
                    ...
                    <div class="container">
                        ...
                        <img src="../../public/img/logo.png" alt="Logo" width="100" height="60"
                            class="d-inline-block align-top" style="position: absolute; top: 10px; right: 1100px;">
                    </div>
                </div>
            </div>
                    ...
                    <form method="post" action="process.php" id="flightForm">
                        <div class="row justify-content-center">
                            <div class="col-md-6 col-lg-3 mb-4">
                                ...
                                <input type="text" class="form-control mb-3" id="maskapai" name="maskapai"
